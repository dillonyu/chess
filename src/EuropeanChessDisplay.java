...
public class EuropeanChessDisplay implements ChessBoardDisplay {
  ...
  public static Color primColor = new Color(215, 224, 228);
  
  /** The secondary color of the checkerboard */
  public static Color secondColor = new Color(132, 164, 178);
  
  /* The color of the SOUTH player */
  public static Color southPlayerColor = Color.white;
  
  /* The color of the NORTH player */
  public static Color northPlayerColor = Color.black;
  ...
  public static Color highlightColor = new Color(173, 220, 224);
  ...
  public void displayEmptySquare(JButton button, int row, int column) {
    button.setBackground((row + column) % 2 == 0 ? primColor : secondColor);
    button.setText(null);
    button.setIcon(null);
  }
